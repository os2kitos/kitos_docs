...
I systemmodulet findes fanen **”Anvendelseshistorik”**.
...
- **Ibrugtagningsdata:** Udfyldes automatisk af systemet
- **Udfasningsdato:** den dag systemet udfases af kommunen
- **Navngivning på ESDH-Sag** – Sagens navn
- **Kommentar** – Frit tekst felt
- **Arkiveringsnavn** – Fastlåst navn på systemet den dag det blev taget ud af anvendelse
- **Lokalt systemnavn** – Hvis kommunen har angivet et lokalt system navn
- **Lokalt systemnavn ID** – Hvis kommunen har angivet et lokalt system navn
- **Nuværende systemnavn** – Dette navn holdes opdateret via systemkataloget
...
- **Bevar historik** – Bevar udvalgte data på systemet og tag system ud af anvendelse. Systemet fjernes fra det lokale systemoverblik og sendes til anvendelseshistorik fanen. Kommunen tælles ikke med som systemanvender i det fælles systemkatalog. *Bemærk relateret kontrakter og databehandler data i de øvrige moduler slettes ikke.*
