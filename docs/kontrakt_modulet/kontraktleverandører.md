...
*Kontraktleverandør-overblikket giver kommunen et samlet overblik over leverandører, sorteret efter kritikalitet.*

*Overblikket hjælper med at identificere leverandører, der er knyttet til kommunens mest kritiske kontrakter, og kan anvendes til prioritering, rapportering og opfølgning på kritiske leverandørrelationer.*
...
Ved klik på en udslagsgivende kontrakt navigeres brugeren direkte til den pågældende kontrakt. Er der mere end 1 udslagsgivende kontrakt, kan du klikke på leverandøren og se alle udslagsgivende kontrakter.
